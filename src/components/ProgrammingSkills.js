...
function ProgrammingSkills() {
	return (
		<div id="programmingSkills">
			<div className="min-h-screen bg-base-200 pt-12 px-20 place-items-center">
					...
					<ul className="list-disc">
						<div className="flex items-center">
							<li className="px-5 py-10">
								...
								database interaction and performance optimization. Developed applications for managing
